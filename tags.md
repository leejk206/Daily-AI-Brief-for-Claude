...
### open-weights
오픈웨이트·오픈소스 모델 출시·생태계·클로즈드 모델 대비 분석

### model-routing
모델 라우팅·요청별 모델 선택·오케스트레이션 라우터

### agent-adoption
에이전트 실사용·기업 도입 현실·진척도에 대한 산업 신호
...
### ai-safety
모델 안전·정렬 연구, 안전 분류기·가드레일·장기실행 리스크

### pricing
모델·API 가격 정책, 토큰 단가·비용 효율 발표

### program-synthesis
백지 상태에서의 프로그램 합성·명세 기반 코드 생성 연구

## Candidate

### math-reasoning
수학·정리증명 등 형식적 추론 능력 및 그 성과
